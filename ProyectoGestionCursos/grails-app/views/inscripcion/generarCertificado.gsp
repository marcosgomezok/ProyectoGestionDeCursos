...
<body>
<h3 class="barra">Generar Certificado:</h3>
<div class="container">
        <!--Formulario con datos obtenidos-->  
  <g:each in="${alumno?}">
  
  <g:form method="post" action="guardarCertificado">
        ...
        <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
          <div class="col p-4 d-flex flex-column position-static">
                ...
                <label for="nombre" class="col-sm-2 col-form-label">Condición de Inscripción:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="tipoInscrip" name="tipoInscrip" value="${it.tipoInscrip}" disabled>
                    </div>
                </div>
                ...
                <div class="form-group row">
                <label for="nombre" class="col-sm-2 col-form-label">Tipo de Certificado:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="tipoCertif" name="tipoCertif" >
                    </div>
                </div>
