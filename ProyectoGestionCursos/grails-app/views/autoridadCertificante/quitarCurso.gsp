...
<div class="container"> 
<div ><h3>Autoridad Certificante:  ${autoridad.nombre} ${autoridad.apellido}</h3></div>
<br>
 <g:if test="${autoridad?.cursos}"> 
 <h4>Cursos:</h4>
<g:each in="${autoridad?.cursos.toList()}">
<div class="row mb-2">
            <div class="col-md-12">
              <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                  ...
                  <g:form controller="autoridadCertificante" action="confirmarQuitar" method="POST">
                    <g:hiddenField name="id" value="${it.id}" />
                    <g:hiddenField name="id_exp" value="${autoridad.id}" />
