...
<body>
<div class="container-fluid" onclick="borrarmsj()">
    <div class="margenseparadorlayouttop">
        ...
        <table>
            ...
            <g:each in="${cursos?}">
            <g:form action="muestraCursoEliminar" method="POST">
            ...
            <tr>
                ...
                <td><div></label><input type="submit" class="linkButton" value="Dar Baja"></div></td>
            </tr>
            </g:form>
            </g:each>            
        </table>
