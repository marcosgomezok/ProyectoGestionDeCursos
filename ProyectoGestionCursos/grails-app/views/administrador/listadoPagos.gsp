...
<div class="margenseparadorlayout">
    <div class="container-fluid">
        ...
        <div class="centrar mb-3"><h3>Listado de inscriptos</h3></div>
            <div class="tabla_nth_child">
                <table>
                    ...
                    <tr>
                        ...
                        <td><div><label id="formapago">${it.cupon.formaPago}</label></div></td>
                        <td><div><label id="fechapago"><g:formatDate format="dd/MM/yyyy" date="${it.cupon.fechaPago}"/></label></div></td>
        ...
        <g:else>  
            <div class="centrar mb-3"><h3>No hay inscriptos</h3></div>
        </g:else>  
            </div>
        <div class="centrar">
