...
<div class="margenseparadorlayout">
    ...
    <g:if test="${inscripciones}">
        <div class="centrar mb-3"><h3>Listado de inscriptos disponibles para ser certificados</h3></div>
            <div class="tabla_nth_child">
                <table>
                    ...
                    <g:form action="seleccionarCertificado" method="POST">
                    ...
                    <tr>
                        ...
                        <td><div><label id="certif">${it.certif.tipoCertif} </label><input type="submit" class="linkButton" value="Modificar Certificado"></div></td>
                    </tr>  
                    </g:form>
                    </g:each>            
                </table>
        ...
        <g:else>  
            <div class="centrar mb-3"><h3>No hay inscriptos disponibles para ser certificados</h3></div>
        </g:else>  
            </div>
        <div class="centrar">
