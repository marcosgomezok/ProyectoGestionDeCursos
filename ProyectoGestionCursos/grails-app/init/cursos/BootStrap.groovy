...
class BootStrap {
    ...
    def inscrip = new Inscripcion(tipoInscrip:"Inscripto", pago:"Pendiente",certif: certifi).save(flush:true)
    if(!aspirante1.save(flush: true)){
    aspirante1.errors.allErrors.each
        println it}
    def adm = new Administrador(dni:40598545,apellido:"Gomez",nombre:"Marcos",email:"marcos2_go2015@hotmail.com",usuario:"marcos",password:123).save(flush: true)
    ...
    def curso1 = new Curso(nombre:"Curso de Python",fecha_desde:fechaD,fecha_hasta:fechaH,cantidad_horas:10,lugar:"UNCA",horarios:"10:00hs",fecha_lim_inscrip:fechaL,fechadel_certificado:fechaC,cupo_minimo:10,cupo_maximo:20,costo:500,estado:"Activo")
    ...
    curso2.save(flush: true)
        ...
        aspirante1.addToIns(inscrip)
        curso2.addToIns(inscrip)
